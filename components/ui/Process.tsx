...
const Process: React.FC = () => {
  ...
  const DetailModal: React.FC<{ step: ProcessStep; index: number; onClose: () => void }> = ({ step, index, onClose }) => {
          ...
          return (
            <>
              {details.activites && (
                <div>
                  <h4 className="text-lg font-bold text-[#53828a] mb-3 flex items-center gap-2">
                    <span aria-hidden="true">📋</span> Activités
                  </h4>
                  <ul className="space-y-2">
                    {details.activites.map((activite, i) => (
                      <li key={i} className="flex items-start gap-2">
                        <span className="text-[#b05f76] mt-1" aria-hidden="true">•</span>
              ...
              {details.livrables && (
                <div>
                  <h4 className="text-lg font-bold text-[#53828a] mb-3 flex items-center gap-2">
                    <span aria-hidden="true">📄</span> Livrables
                  </h4>
                  <ul className="space-y-2">
              ...
              {details.paiement && (
                <div className="bg-gradient-to-r from-blue-50 to-cyan-50 p-4 rounded-xl">
                  <h4 className="text-lg font-bold text-[#53828a] mb-3 flex items-center gap-2">
                    <span aria-hidden="true">💰</span> Conditions de Paiement
                  </h4>
                  <ul className="space-y-2">
          ...
          return (
            <>
              {details.approches && (
                <div>
                  <h4 className="text-lg font-bold text-[#53828a] mb-3 flex items-center gap-2">
                    <span aria-hidden="true">🎯</span> Approches Méthodologiques
                  </h4>
                  <ul className="space-y-2">
              ...
              {details.governance && (
                <div>
                  <h4 className="text-lg font-bold text-[#53828a] mb-3 flex items-center gap-2">
                    <span aria-hidden="true">👥</span> Gouvernance & Communication
                  </h4>
                  <ul className="space-y-2">
              ...
              {details.risques && (
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-4 rounded-xl">
                  <h4 className="text-lg font-bold text-[#53828a] mb-3 flex items-center gap-2">
                    <span aria-hidden="true">⚠️</span> Gestion des Risques
                  </h4>
          ...
          return (
            <>
              {details.methode && details.processus && (
                <div>
                  <h4 className="text-lg font-bold text-[#53828a] mb-3 flex items-center gap-2">
                    <span aria-hidden="true">🔄</span> Méthodologie Agile
                  </h4>
          ...
          return (
            <>
              {details.deploiement && (
                <div>
                  <h4 className="text-lg font-bold text-[#53828a] mb-3 flex items-center gap-2">
                    <span aria-hidden="true">🚀</span> Déploiement
                  </h4>
              ...
              {details.cloture && (
                <div>
                  <h4 className="text-lg font-bold text-[#53828a] mb-3 flex items-center gap-2">
                    <span aria-hidden="true">📚</span> Clôture & Formation
                  </h4>
                  <ul className="space-y-2">
    ...
    return (
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby={`modal-title-${step.title}`}
      >
        <div className="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-200">
          <div className={`sticky top-0 bg-gradient-to-r ${step.gradient} p-6 text-white rounded-t-2xl`}>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 id={`modal-title-${step.title}`} className="text-2xl font-bold">{step.title}</h3>
          ...
          <div className="p-6 space-y-6">{renderModalContent()}</div>
          <div className="sticky bottom-0 bg-gray-50 p-4 rounded-b-2xl border-t border-gray-200">
            <button
              onClick={onClose}
              className="w-full py-3 bg-gradient-to-r from-[#53828a] to-[#b05f76] text-white font-semibold rounded-xl hover:shadow-lg transition-all hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-[#53828a] focus:ring-offset-2"
            >
              Fermer
            </button>
          </div>
  ...
  return (
    <section ref={sectionRef} className="py-16 md:py-24 bg-white relative overflow-hidden" aria-labelledby="process-heading">
      {modalOpen !== null && <DetailModal step={process[modalOpen]} index={modalOpen} onClose={() => setModalOpen(null)} />}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-12 md:mb-20">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-[#53828a]/10 to-[#b05f76]/10 border border-[#53828a]/20 mb-4 md:mb-6 group hover:scale-105 transition-transform duration-300">
            <Sparkles className="w-4 h-4 text-[#53828a] mr-2" aria-hidden="true" />
            <span className="bg-gradient-to-r from-[#53828a] to-[#b05f76] bg-clip-text text-transparent font-semibold text-sm">
              Notre Méthodologie
            </span>
            <Zap className="w-3 h-3 text-[#b05f76] ml-2" aria-hidden="true" />
          </div>
          <h2 id="process-heading" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 relative">
          ...
          <div className="hidden lg:block absolute top-1/2 left-0 right-0 h-px bg-gradient-to-r from-[#53828a]/20 via-[#b05f76]/40 to-[#53828a]/20 transform -translate-y-1/2 z-0" aria-hidden="true"></div>
          ...
          {process.map((step, index) => (
            <div
              ...
              style={{ transitionDelay: `${visibleCards.includes(index) ? step.delay : 0}s` }}
            >
              <Card
                className="border border-gray-100 shadow-lg hover:shadow-xl text-center group relative overflow-hidden cursor-pointer transition-all duration-300 bg-white hover:scale-[1.02]"
                onMouseEnter={() => setHoveredIndex(index)}
                onMouseLeave={() => setHoveredIndex(null)}
              >
                <div className={`absolute inset-0 bg-gradient-to-r ${step.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-500`} aria-hidden="true"></div>
                <CardContent className="p-6 md:p-8 relative">
                  <div className="absolute -top-3 -left-3 w-10 h-10 rounded-full bg-gradient-to-r from-[#53828a] to-[#b05f76] flex items-center justify-center text-white text-sm font-bold shadow-lg group-hover:rotate-12 transition-transform duration-300" aria-label={`Étape ${step.number}`}>
                    {step.number}
                  </div>
                  <div
                    className={`w-16 h-16 lg:w-20 lg:h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-r ${step.gradient} flex items-center justify-center text-white group-hover:rotate-12 transition-all duration-500 shadow-lg relative overflow-hidden`}
                    aria-hidden="true"
                  >
                    ...
                    <div className="transform scale-90 lg:scale-100">{step.icon}</div>
                  </div>
                  ...
                  <p className="text-sm text-[#727683] leading-relaxed mb-4">{step.description}</p>
                  <button
                    onClick={() => setModalOpen(index)}
                    className="opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 text-sm font-semibold bg-gradient-to-r from-[#53828a] to-[#b05f76] bg-clip-text text-transparent inline-flex items-center gap-1 mx-auto focus:outline-none focus:underline"
                    aria-label={`Voir les détails de l'étape ${step.title}`}
                  >
        ...
        <div className="mt-16 md:mt-20 text-center">
          <a
            href="/contact"
            className="group relative inline-flex items-center justify-center px-8 py-3 text-base font-bold text-white bg-gradient-to-r from-[#53828a] to-[#b05f76] rounded-full overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#53828a] focus:ring-offset-2"
            aria-label="Démarrer votre projet avec NEXOLIA"
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-[#b05f76] to-[#53828a] opacity-0 group-hover:opacity-100 transition-opacity duration-300" aria-hidden="true"></div>
            <div className="absolute inset-0 bg-white/20 transform -skew-x-12 group-hover:translate-x-full transition-transform duration-700" aria-hidden="true"></div>
          </a>
        </div>
      </div>
    </section>
